  ...
  strategies:<% if (loginGithub) {%>
    github:
      ...
      conf:
        ...
        clientSecret: "61631bdef37fce808334c83f1336320846647115"<% } %><% if (loginGoogle) {%>
    google:
      ...
      conf:
        ...
        scope: 'https://www.googleapis.com/auth/plus.login'<% } %><% if (loginLinkedIn) {%>
    linkedin:
    ...
    facebook: {
      ...
      conf:
        ...
        callbackURL: 'http://localhost:3000/auth/facebook/callback'<% } %><% if (loginVkontakte) {%>
    vkontakte:
